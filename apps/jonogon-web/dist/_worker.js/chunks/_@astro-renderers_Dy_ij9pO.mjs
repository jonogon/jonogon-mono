...
import { g as getDefaultExportFromCjs } from './astro/server_DslpZdh0.mjs';
...
var l, s;
{
  l = reactDomServerLegacy_browser_development;
  s = reactDomServer_browser_development;
}
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && opts.experimentalReactChildren) {
		...
		const convert = await import('./vnode-children_BPN30Exu.mjs').then((mod) => mod.default);
...
export { React$1 as R, reactExports as a, React as b, renderers as r };
